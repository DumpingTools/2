...
import time
"""
This tool is used to gather information from decompiled apks the information that gets collected is:
emails
APIs
links
...
parser.add_argument("--dir", help="directory to decompiled apk")
